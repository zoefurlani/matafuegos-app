...
export class CreateExtintorDto {
  ...
  @IsIn(['ABC', 'CO2', 'AFFF', 'HCFC', 'K'], {
    message: 'El tipo debe ser: ABC, CO2, AFFF, HCFC o K',
  })
  tipo: string;
  ...
  @IsOptional()
  @IsString()
  @IsIn(['activo', 'vencido', 'en_mantenimiento'], {
    message: 'El estado debe ser: activo, vencido o en_mantenimiento',
  })
  estado?: string;
}